...
class BaseGA(Root):
    ...
    def __init__(self, obj_func=None, lb=None, ub=None, problem_type=0, _mat__=None, verbose=False, epoch=750,
                 pop_size=100, pc=0.95, pm=0.025, **kwargs):
    ...
    def train(self):
        ...
        g_best = self.get_global_best_solution(pop, self.ID_FIT, self.problem_type)
        ...
        for epoch in range(0, self.epoch):
            ...
            showBest = [epoch + 1] + [int(a) for a in g_best[self.ID_POS]]
